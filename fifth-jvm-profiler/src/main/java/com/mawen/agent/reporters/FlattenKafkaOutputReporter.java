...
public class FlattenKafkaOutputReporter extends KafkaOutputReporter {
	...
	public static final String ARG_TOPIC_LOWERCASE = "topicLowercase";
	...
	public String getTopic(String profileName) {
		String topic = super.getTopic(profileName);
		if (topicLowercase) {
	...
	public void setTopicLowercase(Boolean topicLowercase) {
		this.topicLowercase = topicLowercase;
	}
					...
					for (Map<String, Object> metricMap : metricList) {
						...
						for (Map.Entry<String, Object> entry1 : metricMap.entrySet()) {
							if (StringUtils.isNotEmpty(name)) {
								...
								formattedMetrics.put(key + "-" + entry1.getKey(), entry1.getValue());
							}
						}
						num++;
					}
