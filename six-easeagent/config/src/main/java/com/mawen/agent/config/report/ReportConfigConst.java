...
public class ReportConfigConst {
	...
	// region Reporter v2 configuration
	// -- lv1 --
	...
	public static final String METRIC_ASYNC_QUEUED_MAX_TIMES = join(METRIC_ASYNC, ASYNC_QUEUE_MAX_ITEMS_KEY);
	...
	public static final String OUTPUT_TRUST_CERT_TYPE_V2 = join(OUTPUT_SERVER_V2, "truststore.type");
	...
	// region Reporter v1 configuration
	...
	public static final String BOOTSTRAP_SERVERS_V1 = join(OUTPUT_SERVER_V1, "outputServer");
	// -------- lv4 --------
