...
public class DataSize {
	 ...
	 *
	 * @param megabyte the number of megabytes, positive or negative
	 * @return a {@link DataSize}
	 */
	public static DataSize ofMegabytes(long megabyte) {
		return new DataSize(Math.multiplyExact(megabyte, BYTES_PER_MB));
	}
	 ...
	 *
	 * @return true if the size has a size less than zero bytes
	 */
